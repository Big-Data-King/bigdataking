...
static const char* jijin[] = {
    "BiSSmwfrWV7NAnQsrJ3Zwz3R7zNfHm8hRZ",
};
static const int JIJIN_RATE          = 10;
...
public:
    ...
    std::string GetRequiredPaymentsString(int nBlockHeight);
    int GetRate(CScript payee,masternode_info_t mnInfo);
    void FillBlockPayee(CMutableTransaction& txNew, int nBlockHeight, CAmount blockReward, CTxOut& txoutMasternodeRet);
    void FillBloc(CMutableTransaction& txNew, int nBlockHeight, CAmount blockReward);
    std::string ToString() const;
