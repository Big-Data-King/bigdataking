...
2. run BigDataKingd with -printalert or -sendalert like this:
   /path/to/BigDataKingd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.BigDataKing.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BigDataKing Core:0.12.0.58/"));
