 ...
 *
 *   // network
 *   CBigDataKingNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.BigDataKing.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBigDataKingNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBigDataKingNetwork(UniValue objIn)
    {
...
// // can be under: BigDataKingNetwork
// //   -- signature requirements : Key1(User)
// class CBigDataKingNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == BigDataKingNetwork);
//     // }
