...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BigDataKing Core BigDataKing-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  BigDataKing-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BigDataKing transaction") + "\n" +
              "  BigDataKing-tx [options] -create [commands]   " + _("Create hex-encoded BigDataKing transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BigDataKing transaction
