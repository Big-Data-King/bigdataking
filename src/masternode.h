...
static const CAmount BIG_MASTERNODE_AMOUNT              = 50000000*COIN;
static const int BIG_MASTERNODE_AMOUNT_RATE             = 30;
static const CAmount SMALL_MASTERNODE_AMOUNT            = 30000000*COIN;
static const int SMALL_MASTERNODE_AMOUNT_RATE           = 10;
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 BDK - checking if valid masternode)
