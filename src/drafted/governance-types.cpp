...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BigDataKingNetwork") type = BigDataKingNetwork;
    if(strType == "BigDataKingNetworkVariable") type = BigDataKingNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BigDataKingNetwork) s = "BigDataKingNetwork";
    if(type == BigDataKingNetworkVariable) s = "BigDataKingNetworkVariable";
