...
#define BOOST_TEST_MODULE BigDataKing Test Suite

#include "test_BigDataKing.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_BigDataKing_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
