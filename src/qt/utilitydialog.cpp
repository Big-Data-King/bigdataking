    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BigDataKing Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BigDataKing Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  BigDataKing-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BigDataKing in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BDK, 0.1 BDK, 1 BDK and 10 BDK -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BigDataKing Core is shutting down...") + "<br /><br />" +
