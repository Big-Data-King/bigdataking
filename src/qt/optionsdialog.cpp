    ...
    mapper(0)
{
    ...
    // cant display theme list
//    ui->theme->setVisible(false);
    /* Theme selector */
    ui->theme->addItem(QString("BDK-light"), QVariant("light"));
    ui->theme->addItem(QString("BDK-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BDK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BDK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BDK-traditional"), QVariant("trad"));
