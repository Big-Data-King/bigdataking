    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BigDataKing Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BigDataKing address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BigDataKing: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BigDataKing Core"), this);
    aboutAction->setStatusTip(tr("Show information about BigDataKing Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BigDataKing Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BigDataKing addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BigDataKing addresses"));
    ...
    openAction->setStatusTip(tr("Open a BigDataKing: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BigDataKing Core help message to get a list with possible BigDataKing Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BigDataKing Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BigDataKing network", "", count));
    } else {
...
{
    QString strTitle = tr("BigDataKing Core"); // default title
    ...
    // Append title to "BigDataKing Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
