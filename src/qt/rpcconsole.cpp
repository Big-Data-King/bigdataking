...
//        this->setStyleSheet("*{background-color: #16161F;color: #d3d3e0;}"
//                          "QTabWidget::pane {border: 1px solid #3f3f5b;}"
//                          "QTabWidget QTabBar::tab {background-color:#20202E;padding: 8px 10px;border-top: 1px solid #3f3f5b;}"
//                          "QTabWidget QTabBar::tab:first {border-left: 1px solid #3f3f5b;}"
//                          "QTabWidget QTabBar::tab:last {border-right: 1px solid #3f3f5b;}"
//                          "QTabWidget QTabBar::tab:selected, .QTabWidget QTabBar::tab:hover {background-color:#16161f;color:#3e8ef7;}"
//                            "QHeaderView::section {qproperty-alignment:center;background: #20202E;min-height:25px;font-weight:bold;border-top:1px solid #3f3f5b;border-right:1px solid #3f3f5b;border-bottom:1px solid #3f3f5b;padding: 3px 5px;    }"
//                            "QHeaderView::section:hover{background: #16161f;}"
//                            "QHeaderView::down-arrow, QHeaderView::up-arrow{width: 14px;height: 14px;margin-right: 3px;}"
//                            "QHeaderView::down-arrow {image:url(':/images/light/drkblue_downArrow_small');}"
//                            "QHeaderView::up-arrow {image:url(':/images/light/drkblue_upArrow_small');}"
//                            ".QTableView, QTableWidget {border:0px;border-collapse: collapse;gridline-color: #3f3f5b;font-size:12px;}"
//                            "QTableView::item {background: #2a2a3d;border:0px;margin: 0;font-size:12px;}"
//                            "QTableView::item:selected {background: #20202e;color: #3e8ef7}"
//                            );
//
//    }
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BigDataKing Core RPC console.") + "<br>" +
